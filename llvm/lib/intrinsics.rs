...
pub const MINIMUM_F32: Intrinsic = intrinsic!("llvm.minimum.f32", (LLVMFloatType, LLVMFloatType) -> LLVMFloatType);

pub const MINIMUM_F64: Intrinsic = intrinsic!("llvm.minimum.f64", (LLVMDoubleType, LLVMDoubleType) -> LLVMDoubleType);

pub const MAXIMUM_F32: Intrinsic = intrinsic!("llvm.maximum.f32", (LLVMFloatType, LLVMFloatType) -> LLVMFloatType);

pub const MAXIMUM_F64: Intrinsic = intrinsic!("llvm.maximum.f64", (LLVMDoubleType, LLVMDoubleType) -> LLVMDoubleType);

pub const COPYSIGN_F32: Intrinsic = intrinsic!("llvm.copysign.f32", (LLVMFloatType, LLVMFloatType) -> LLVMFloatType);

pub const COPYSIGN_F64: Intrinsic = intrinsic!("llvm.copysign.f64", (LLVMDoubleType, LLVMDoubleType) -> LLVMDoubleType);
...
pub const ROUND_EVEN_F32: Intrinsic = intrinsic!("llvm.trunc.f32", (LLVMFloatType) -> LLVMFloatType);

pub const ROUND_EVEN_F64: Intrinsic = intrinsic!("llvm.trunc.f64", (LLVMDoubleType) -> LLVMDoubleType);
